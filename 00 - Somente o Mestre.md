...
aliases:
  ...
  - Material secreto
status: consolidado
fontes: ["derivado das marcações conhecimento: segredo"]
conhecimento: segredo
---

# Somente o Mestre

> [!danger] Zona de spoilers pesados
> Tudo abaixo revela verdades que a obra guarda para o final, e que quase nenhum
> habitante daquele mundo conhece. Se você pretende ler o romance, **pare aqui** e
> volte depois. Se você é jogador, isto não é para você.

Estas notas contêm o que o mundo esconde. Não são "lore extra": são as regras que
explicam *por que* o mundo funciona como funciona — e é justamente por isso que
descobri-las, na mesa, deve ser uma conquista, não um pressuposto.

O material de mestre está em três formatos diferentes, e vale saber distinguir antes de
mergulhar: **notas inteiras** de nível segredo (as listadas nas próximas seções), **seções
finais** dentro de notas liberadas (a tabela de corte mais abaixo), e **fatos avulsos
marcados dentro do parágrafo** — o formato usado nas pastas de Forças e de Eventos, onde
uma organização ou um cenário podem ser inteiramente públicos e ter um único fato oculto no
meio da ficha.
...
- [[15 - Sociedade Fora das Cinco Regiões|Sociedade Fora das Cinco Regiões]] — o outro lado da mesma moeda: **a maior parte das
  pessoas governadas por um cultivador imortal não mora em região nenhuma** — mora dentro
  dele, num mundo particular que não aparece em mapa, sob leis que ele escreve. Também aqui
  só a existência dos dois céus é comum; cada seção declara o próprio nível.
...
- [[24 - Human Path|Human Path]] — o caminho que toma a humanidade inteira como matéria-prima de cultivo:
  as profissões, os cargos, as virtudes, a vontade das multidões. É segredo porque é
  **a única ferramenta conhecida para enfrentar a vontade do céu** — saber que ele existe já
  é saber que o céu tem um adversário possível.
- [[28 - Painting Path|Painting Path]] — criado em segredo absoluto por um Venerável que nunca o ensinou a
  ninguém, e por isso o único caminho do mundo que jamais decaiu, porque jamais se difundiu.
  Praticamente ninguém sabe que ele existe.
...
[[01 - Visão Geral dos Eventos|Visão Geral dos Eventos]] separa isso explicitamente na
própria nota, e a separação importa: os cenários são feitos para ser jogados, mas **a causa
verdadeira de alguns deles é material de mestre**. Guarde para si:

- **Que a força de uma calamidade mede o tesouro guardado**, e que o calendário de
  calamidades do mundo é, por isso, um mapa de onde roubar.
- **Que marés e desastres podem ser fabricados**, e usados como arma, aríete ou álibi.
- **Que existem eventos cujo resultado já foi combinado** por gente que nunca vai pisar no
...
Estas notas são majoritariamente seguras para jogadores, mas têm trechos que não são.
Se for distribuí-las, corte o que está indicado:
...
| [[12 - Povos e Variantes Humanas\|Povos e Variantes Humanas]] | a razão histórica da supremacia humana. Os povos e seus traços são conhecimento de qualquer aldeão; **que a supremacia humana foi engenharia cósmica**, e não mérito, não é |
| [[17 - Zumbis e Corpos Transformados\|Zumbis e Corpos Transformados]] | por que zumbis passaram a existir, e que caçá-los é literalmente engenharia cósmica. Que zumbis existem é senso comum; **para que serve matá-los** não é |
| [[18 - Modificar o Próprio Corpo\|Modificar o Próprio Corpo]] | a possessão como tecnologia negociada entre grandes forças, os corpos fabricados em série, as raças criadas de propósito a partir de humanos, e o retorno dos Veneráveis. O arsenal de reforço corporal continua liberado |
| [[04 - Família, Ancestrais e Ritos\|Família, Ancestrais e Ritos]] | que os Gu do salão ancestral localizam e ferem um membro à distância, que são adulteráveis, e que o "ancestral" que responde ao clã pode não ser um espírito |
| [[07 - Lei, Crime e Castigo\|Lei, Crime e Castigo]] | que a Placa de Julgamento é uma máquina de detecção automática, quem cuida dela, e que uma caçada regional aparentemente espontânea pode ter começado com um relatório do topo do mundo |
| [[08 - Juramentos, Reputação e Favores\|Juramentos, Reputação e Favores]] | que os instrumentos de juramento têm gerações tecnológicas e que a atual pode estar obsoleta; que existe anulação **unilateral**; e que toda grande aliança tem um ponto no mapa que a mata |
| [[09 - Informação, Rumores e Espionagem\|Informação, Rumores e Espionagem]] | as redes de agentes plantados com vidas inteiras de cobertura, o fato de espiões inimigos cooperarem entre si, e os métodos de contra-dedução |
| [[10 - Guerra Organizada\|Guerra Organizada]] | que "convidar aliados" é frequentemente contratá-los como bucha, e que o pretexto vem sempre antes do motivo |
| [[06 - O Subsolo\|O Subsolo]] | o item marcado com 🔒 (o monopólio da moeda imortal), a indetectabilidade de uma propriedade abaixo da quadragésima camada, e que uma maré de bestas pode **subir** |
...
| [[09 - Gu Imortais por Rank e Caminho\|Gu Imortais por Rank e Caminho]] | **a nota inteira**, pela mesma razão do catálogo de golpes. Cada Gu Imortal existe em um único exemplar no mundo, e por isso a lista do que uma facção possui **é a ficha de força dela**: golpe conhecido é golpe deduzido, e Gu Imortal conhecido é Gu Imortal caçado. Libere ficha a ficha, conforme a mesa esbarrar em cada um |
| [[07 - Gu de Rank 4\|Gu de Rank 4]] e [[08 - Gu de Rank 5\|Gu de Rank 5]] | nada, se a mesa já joga nessa faixa. Para uma mesa iniciante, a nota inteira: que existem pessoas desse patamar é senso comum, mas o miolo das duas — receitas, preços de leilão, rotas de avanço — as próprias notas declaram como saber de ancião de clã para cima, e no rank 5 de cúpula de grande força |
...
> [!note] Para o design
> A obra trata o conhecimento como recurso disputado: quem entende o sistema por dentro
> derrota quem tem mais poder bruto. Um jogo fiel a isso não entrega este material de
> graça — ele o transforma em recompensa. Descobrir que a sorte é um caminho cultivável,
> ou que o destino é um objeto danificado, deveria valer tanto quanto um artefato.
>
> Repare que boa parte dos segredos acima tem a mesma forma: **uma coisa que todo mundo
> conhece serve, na verdade, a uma função que ninguém suspeita.** Caçar zumbi conserta o
> destino; o salão ancestral é um sistema de vigilância; a caçada regional começou num
> relatório do topo do mundo; a supremacia da própria espécie foi arranjada. É um molde de
> revelação reutilizável — e você pode aplicá-lo a qualquer instituição que inventar.
