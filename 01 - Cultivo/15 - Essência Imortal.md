...
A [[14 - Ascensão Imortal|ascensão ao rank 6]] quebra esse arranjo em dois pedaços, e é essencial entender que **as duas metades vão para lados opostos**:
...
A trava mais importante é a penúltima linha. Refinar um [[16 - Gu Imortais|Gu Imortal]] **não pode ser feito com essência primordial** — por mais que o imortal tenha essência primordial infinita, ela não serve. Toda a economia da camada imortal existe por causa dessa única frase.
...
Quem entra para o [[19 - Tribunal Celestial|Tribunal Celestial]] entrega a própria abertura imortal, que é fundida à gruta-céu da organização. Em troca, ao sair a campo, recebe uma **abertura fantasma** — uma carteira pura, e nada além disso:
...
O câmbio completo, os preços de mercado e a renda esperada por rank vivem em [[15 - Economia Imortal|Economia Imortal]] e em [[02 - Tabelas de Referência Rápida|Tabelas de Referência Rápida]]. O que basta guardar aqui é a forma da escada:
...
flowchart TD
    ...
    S -->|"por vontade, a distancia"| U1["Ativar Gu e golpes imortais"]
    S -->|"manuseio: conta na palma"| U2["Alimentar Gu Imortal<br/>a essencia e a comida dele"]
    S -->|"sentido divino entra na abertura"| U3["Fundir contas para o grau acima"]
    S -->|"entregue por um Gu carregador"| U4["Alimentar Casa de Gu Imortal<br/>unica coisa que aceita essencia alheia"]
    U3 --> E
    U1 --> X["Essencia consumida"]
    U2 --> X
    U4 --> X
    X -.->|"o nucleo repoe com o tempo"| B
    D["Abertura morta, dono morto<br/>ou tempo desacelerado"] -->|"corta a reposicao"| B
    A2["Ataque ao estoque"] -->|"contas se desintegram"| S
```
...
- [[14 - Ascensão Imortal|Ascensão Imortal]] — o momento em que a abertura vira território e o primeiro lote de contas nasce.
- [[14 - Viver Dentro da Abertura Imortal|Viver Dentro da Abertura Imortal]] — o núcleo de origem como órgão vital, o tempo interno e a rotina de administrar a propriedade.
- [[16 - Produzir Gu Dentro da Abertura|Produzir Gu Dentro da Abertura]] — os pontos de recurso que engordam o núcleo, e a outra fábrica que a terra abriga.
- [[15 - Economia Imortal|Economia Imortal]] — o câmbio completo, o mercado e o que a essência compra.
- [[02 - Tabelas de Referência Rápida|Tabelas de Referência Rápida]] — a fonte soberana de todos os números.
- [[16 - Gu Imortais|Gu Imortais]] — o que come a essência, e as Casas que aceitam a de estranhos.
- [[17 - Zumbis e Corpos Transformados|Zumbis e Corpos Transformados]] — o que é viver com uma abertura que não repõe.
- [[19 - Tornar-se Venerável|Tornar-se Venerável]] — por que produzir lichia-branca é condição formal para chegar ao topo.
- [[19 - Tribunal Celestial|Tribunal Celestial]] — quem emite as pedras, e a abertura fantasma que substitui a de verdade.
