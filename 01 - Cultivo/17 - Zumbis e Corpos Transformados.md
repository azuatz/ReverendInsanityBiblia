...
> foi preenchido, e a nota diz isso em voz alta onde acontece.
>
> Nesta nota **não há um único item marcado com `*`**: tudo aqui é canônico ou dedução
> declarada. Ela é, portanto, cem por cento aproveitável mesmo por quem só queira o que a
> obra afirma.

## Por que isto é cultivo, e não um bicho de cenário
...
|---|---|---|
| 2 | Gu do Zumbi Errante (*roaming zombie*) | a porta de entrada: qualidades de zumbi **temporárias**, enquanto o Gu estiver ativo |
| 3 | Gu do Zumbi Peludo (*fur / hairy zombie*) | — |
| 4 | Gu do Zumbi Saltador (*hopping / jumping zombie*) | — |
| 5 | Gu do Zumbi Voador (*flying zombie*) | o primeiro patamar capaz de **voar** |
...
No topo da escada, o nível 5 se abre em **cinco variantes paralelas**, os Cinco Grandes Zumbis Voadores: *asura*, *demônio celestial*, *espectro de sangue* (**blood wight**), *pesadelo* e *praga*. São cinco especializações distintas, e a obra detalha o *asura*: defesa e regeneração multiplicadas, dor quase abolida, ferimentos até o osso fechando em segundos, e um golpe próprio que faz o corpo crescer para uns três metros e brotar seis braços de bronze. Existe ainda um **sexto** Gu voador, raríssimo e fora da lista clássica, o *zumbi chefe da terra*.
...
A obra dá ao processo um **indicador de progresso literal e visível**, e ele é a melhor mecânica desta nota. Transformações zumbis temporárias acumulam no corpo uma "energia dos mortos" incompatível com a carne viva, e o acúmulo se manifesta como ==manchas de zumbi (zombie speckles)== — marcas que aparecem na pele e vão se alastrando. Um ponto nas costas vira as costas inteiras. **Quando as manchas cobrirem o corpo todo, a transformação é permanente e irreversível.**

Duas regras práticas que acompanham:

- **Existe um limite seguro por ativação.** Um golpe de transformação zumbi bem construído pode ser usado tantas vezes quanto se queira **sem acumular manchas**, desde que cada ativação não passe de cerca de **trinta minutos** para um Mestre Gu mortal, ou cerca de **uma hora** para um Gu Imortal. O que gera manchas não é a quantidade de usos: é o **tempo contínuo** de cada um.
- **A vitalidade do usuário estende o limite.** É por isso que o teto do imortal é o dobro do teto do mortal — e é uma regra geral, não uma exceção deste golpe: transformações que custam força vital rendem mais tempo nas mãos de quem tem mais força vital para gastar.

> [!note] Para o design
> Aqui está uma barra de corrupção **desenhada pelo próprio autor**, e melhor que a média do gênero: ela é visível na ficha *e* no corpo do personagem, avança por tempo contínuo em vez de por número de usos (o que premia disciplina, não abstinência), tem um limite seguro publicado, e o ponto final é uma mudança de categoria de existência e não a morte. Um jogador que veja a primeira mancha aparecer sabe exatamente o que está acontecendo e quanto ainda lhe resta.

## Os zumbis que ninguém escolheu ser
...
- **A infecção se propaga sozinha.** A toxina de putrefação transforma novos cadáveres em zumbis indefinidamente. Um campo de batalha malcuidado vira um problema permanente.
- **Comandar uma horda custa concentração contínua**, não energia. Controle grosseiro é sustentável; controle fino esgota a mente do comandante em cerca de um dia, e a recuperação leva o resto da noite. Os brancos, na prática, são **munição descartável**: existem para gastar a essência dos defensores antes que os pretos cheguem.

## O zumbi imortal

Esta é a categoria que muda o mundo, e ela merece tratamento próprio porque **não é o mesmo fenômeno em escala maior**.
...
Tudo o que define um zumbi imortal decorre de um único fato: **a abertura dele morre com ele**. E como a abertura de um imortal é um mundo em miniatura onde ele mora, um mundo morrer é diferente de um órgão parar.

**O que a abertura morta deixa de fazer:**
...
- **Nenhuma provação, nunca mais.** Este é o benefício que os vivos invejam em voz alta. Há um imortal vivo que diz, textualmente, que às vezes gostaria de virar zumbi só para não ter que enfrentar calamidades. E há a formulação que resume a categoria inteira: *"a vida tem suas vantagens, a morte tem suas utilidades"*.
- **Aguenta mais.** Uma abertura morta suporta pressões internas que estourariam uma viva — há registro de uma que só sobreviveu a uma carga extrema **porque** já estava morta.
- **Não conflita com aberturas alheias.** Como a abertura morta não tem dao marks vivos, ela pode entrar em outra abertura sem causar o conflito que um imortal vivo causaria.

### O corpo do zumbi imortal

Um catálogo de propriedades que vale como ficha pronta de adversário:

- **Não come, não bebe, não respira.** Fôlego ilimitado debaixo d'água é vantagem tática real, não sabor.
- **Não sente dor nem fadiga.** E, junto com a dor, perde parte da **percepção**: um zumbi pode não notar um toque furtivo que implanta nele um Gu hostil.
- **Não tem tempo de vida a gastar.** É a imunidade mais valiosa do sistema: golpes que cobram anos de vida do usuário simplesmente **não podem ser acionados** por um zumbi, e ataques que drenam vitalidade alheia **não pegam nele**. Um zumbi consegue permanecer indefinidamente sob uma luz que consome os anos de todo mundo em volta — "os mortos não têm tempo de vida, por mais que fique ali, ele não morrerá de velhice".
...
Não é um beco sem saída — mas nenhuma das saídas é limpa. A obra documenta sete caminhos, e a tabela abaixo é o cardápio completo.

| Método | Como funciona | O que custa e o que limita |
|---|---|---|
...
Escondida na quinta linha da tabela está a ideia mais engenhosa do domínio inteiro, e ela inverte tudo o que foi dito até aqui.

A **abertura de vida-e-morte** não é apenas uma cura. Quem revive por esse caminho fica com uma abertura que contém, ao mesmo tempo, os mistérios da vida e os da morte — e o efeito permanente disso é que **todas as calamidades e tribulações futuras vêm com metade da força, sem que os dao marks ganhos sejam reduzidos em nada**.
...
Quem vai até o fim da transformação — voluntária ou não — paga uma conta que a obra encena numa cena só, e que vale enunciar inteira:

**Todo o corpo perde a força vital, e isso inclui todas as aberturas que a pessoa tenha, mortais e imortal.** O avanço de cultivo cessa para sempre. Em termos de potencial, a formulação usada é a mais dura possível: fica-se "pior que um mortal", porque um mortal ao menos ainda pode crescer.
...
## Os outros corpos transformados
...
Conhecimento de rua, incluindo entre mortais sem talento:
...
Conhecimento de especialista, que circula entre Mestres Gu instruídos e imortais:

- A escada completa de Gu de zumbi por rank, as cinco variantes de topo, e o fato de que a linhagem pertence ao caminho da transformação.
- As manchas de zumbi como marcador de progresso, o limite seguro por ativação e o ponto sem volta.
- Que a abertura de um zumbi imortal **morre**: não produz energia, se desintegra aos poucos, não enfrenta provações e, por isso, **não ganha dao marks** — o cultivo dele acabou.
- Que existe uma organização mundial de zumbis imortais, com pesquisa própria acumulada sobre a condição.
- Que corpos de zumbis imortais são material de refino valioso, e que por isso eles são caçados.
- Que existem métodos de revivificação, todos caros, arriscados ou de uso único.
