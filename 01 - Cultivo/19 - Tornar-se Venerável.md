...
**Em uma frase:** o ==Venerável (Venerable)== é o rank 9, o teto absoluto do sistema — **um por era, dez em toda a história do mundo** — e não é um título honorífico: é o resultado de quatro condições formais, a última das quais consiste em romper um bloqueio que o próprio céu montou para impedir que alguém chegue lá.[^1]
...
A diferença é ontológica, não quantitativa. Um Gu de rank 9 não é feito de [[16 - Dao Marks|dao marks]] como todos os outros: é feito de **fragmentos das leis do universo** propriamente ditas. É por isso que um Gu de rank 9 continua funcionando em lugares onde nenhum Gu de rank 1 a 8 sequer liga.
...
**1. O núcleo da abertura imortal precisa produzir essência imortal de terceiro grau.** A energia que uma abertura imortal gera tem quatro denominações crescentes, uma por rank — uva-verde no 6, tâmara-vermelha no 7, **lichia-branca no 8**, damasco-amarelo no 9 —, e cada degrau vale cerca de cem vezes o anterior. A escala de valor completa, com o câmbio para a moeda dos imortais, está em [[02 - Tabelas de Referência Rápida#5. Escala de valor das essências imortais]]; a mecânica de produção, em [[14 - Ascensão Imortal|Ascensão Imortal]]. A condição é ter o núcleo já **produzindo lichia-branca** — é pré-requisito, não resultado.

**2. O caminho principal precisa ter no mínimo 300.000 dao marks.** Para calibrar, use as faixas de [[16 - Dao Marks|Dao Marks]]: um rank 6 vai de zero a 9.000; um rank 7, de 10.000 a 30.000; um rank 8, de 100.000 a 300.000. Ou seja, a condição 2 é exatamente **fechar o rank 8 inteiro** — os 300.000 são o teto do que o calendário completo de provações do rank 8 rende, nem um a mais.

**3. O caminho principal precisa estar em attainment de supremo grão-mestre — e este é o gargalo real.** Quase-supremo grão-mestre está perto e **não é a mesma coisa**. Supremo grão-mestre não significa compreender toda a profundidade de um campo do conhecimento: significa **inovar** dentro dele, elevando o teto do campo inteiro — e, em alguma medida, do próprio céu e terra. É por isso que nenhuma herança do mundo, por mais completa, entrega esse degrau: inovação, por definição, não se herda. Ver [[08 - Attainment|Attainment]].

**4. Romper o bloqueio do Caminho Celestial.** Cumprida esta, o núcleo passa a produzir a essência de rank 9, e a pessoa é Venerável.
...
E há um traço técnico que os une: **todos os dez compreenderam algo do mito fundador do mundo e criaram os próprios golpes de caminho humano de nível topo**. Métodos de caminho humano são a via eficaz de interferir no Caminho Celestial. Quem quer quebrar as regras do céu precisa, primeiro, entender profundamente o que significa ser humano.
...
- **Recupera-se** no ==Domínio Primordial (Primordial Domain)==, o domínio recluso de céu e terra escondido na camada mais profunda da [[25 - A Caverna do Demônio Enlouquecido|Caverna do Demônio Enlouquecido]]: entrar nele eleva **um** caminho do visitante direto a supremo grão-mestre, e por isso devolve o senhorio a um Venerável que o perdeu. É o único atalho conhecido para o nono degrau de [[08 - Attainment|attainment]].
...
## Perfil estrutural dos dez

Estes são os traços comuns confirmados, úteis como material de worldbuilding e não como enredo:

- **Nove homens e uma mulher** — não há restrição de gênero no sistema.
- **Nunca existiram dois Veneráveis vivos ao mesmo tempo.** A formulação do mundo é "dois reis não coexistem". Confrontos entre Veneráveis de eras diferentes só ocorrem através de métodos deixados para trás.
- **Nenhum é onipotente.** Houve Veneráveis que precisaram de ajuda de terceiros para refinar seus próprios Gu.
- **Todos tiveram um "Dao Guardian" (guardião do Dao)** num momento crucial do crescimento — uma instituição informal do sistema, e um detalhe delicioso: o guardião podia ser **amigo ou inimigo**. O que importa é ter tido alguém que forçou o crescimento.
- **Todos tiveram supremo grão-mestre no caminho principal**, publicamente reconhecido.
- **Todos eram humanos puros.**
- **Nenhum tinha uma constituição extrema** — as provações aceleradas os teriam matado antes de chegarem lá. O melhor talento do mundo é comprovadamente um caminho sem saída para o topo.
- **Todos foram restritos pelo tempo de vida.** O mais longevo da história viveu 25.000 anos; o de vida mais curta, cerca de 3.000. Há registro histórico de Veneráveis caçando Gu de longevidade com toda a sua força — o ser mais poderoso de uma era gastando essa força atrás do mesmo item escasso que um clã de fronteira persegue.

E o ponto que fecha o domínio: **nem o rank 9 vive para sempre**. Veneráveis morrem. O que sobrevive deles são os métodos gravados no mundo, as vontades residuais dentro de suas criações e as heranças que deixaram — que continuam decidindo o destino de gerações que nunca os conheceram. Mesmo o rank 9 tem apenas longevidade, não vida eterna: uma distinção formal explicada em [[12 - Longevidade|Longevidade]].

> [!warning] Uma inconsistência numérica registrada
> A obra fecha em **dez** Veneráveis ao longo de praticamente todo o texto, e é essa a contagem que estas notas adotam. Uma passagem tardia fala em onze — provavelmente incluindo alguém posterior ou um pseudo-Venerável revivificado. Registrado para transparência; não altera nada de estrutural.

> [!note] Para o design
> O rank 9 é o exemplo mais completo do que este sistema faz de melhor: **o teto não é uma barra de experiência maior, é uma lista de condições heterogêneas**. Uma é econômica (o núcleo precisa ter amadurecido até certo estágio produtivo). Uma é quantitativa (300.000 dao marks). Uma é criativa (inventar algo novo num campo do conhecimento — e é essa que barra a maioria). E uma é política (romper um bloqueio que o antagonista cósmico mantém de propósito, o que na prática exige devoção popular em massa ou o favor do próprio inimigo).
>
> Três consequências de mesa: (1) o objetivo final de uma campanha longa pode ser explicitado como uma lista de quatro itens, e ainda assim ser inatingível de formas interessantes; (2) o "Dao Guardian" que pode ser amigo ou inimigo é um dos melhores ganchos de personagem já embutidos num sistema de progressão — o antagonista recorrente da campanha *é* parte do requisito de vitória; (3) o Dao Lord dá ao mestre uma justificativa mecânica para que técnicas antigas continuem funcionando e para que o mundo inteiro esteja coberto pelas digitais de gente morta há eras.

## Relações

- [[08 - Attainment|Attainment]] — supremo grão-mestre, o gargalo real das quatro condições.
- [[16 - Dao Marks|Dao Marks]] — o requisito quantitativo, e a substância do poder de um Dao Lord.
- [[13 - Tribulações e Calamidades|Tribulações e Calamidades]] — as três tribulações miríades como portão de entrada.
- [[12 - Longevidade|Longevidade]] — a trava que restringiu todos os dez.
- [[14 - Ascensão Imortal|Ascensão Imortal]] — o começo da estrada que termina aqui.
- [[01 - Visão Geral do Cultivo|Visão Geral do Cultivo]] — o mapa completo do domínio.

[^1]: A tradução brasileira usa "Venerável", e distingue "Venerável Imortal" (na via correta) de "Venerável Demônio" (na via demoníaca) — a ordem das palavras varia pontualmente entre capítulos, aparecendo também como "Demônio Venerável". As duas designam o mesmo rank 9; a diferença é de alinhamento, não de poder.
