...
- **Que os "caminhos" (paths) não são categorias naturais**: cada um foi **inventado e
  sistematizado por alguém**, em algum momento da história. Ver [[01 - Visão Geral dos Paths|Visão Geral dos Paths]].
...
- [[01 - Visão Geral dos Paths|Visão Geral dos Paths]] — como os Gu se organizam em famílias temáticas de cultivo.
- [[04 - Essência Primordial|Essência Primordial]] — a energia que aciona tudo.
- [[05 - Ranks e Avanço|Ranks e Estágios de Cultivo]] — a escala de 1 a 9 que Gu e Mestres compartilham.
- [[03 - Catálogo de Gu|Catálogo de Gu]] — a lista dos Gu documentados.
