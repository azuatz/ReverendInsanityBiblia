...
> Esta é a **porta de entrada** da pasta `02 - Gu`. Ela dá o quadro inteiro em poucas
> páginas. Cada tópico tem uma nota própria, mais funda, apontada por wikilink.

## Resumo

Neste mundo não existe "magia" no sentido usual: ninguém lança feitiços, ninguém decora
grimórios. Existe uma coisa só — o ==Gu==.

Um Gu é uma **criatura viva sobrenatural**, normalmente do tamanho de um inseto (verme,
besouro, borboleta, mas também plantas pequenas e bichos miúdos), e cada Gu concentra em
si **exatamente um poder**. Um Gu que emite lâminas de luar. Um Gu que endurece a pele.
Um Gu que transforma vinho em energia. Um Gu que troca você de lugar com outra pessoa.
Um poder por bicho, sem exceção, do mais fraco ao mais absurdo.
...
um deles num processo chamado [[Refino de Gu|refino]], **alimenta** cada um com a dieta
...
criação de animais** somada a um **sistema de crafting com taxa de falha**. Cada "magia"
que um personagem possui é uma boca que come todo mês, um ativo que pode morrer, e um item
que alguém pode querer roubar.

## Regras do mundo

Estas são as regras estruturais do domínio. Elas valem em toda a obra e sustentam todas as
notas desta pasta.

1. **Um Gu, um poder.** Nenhum Gu faz duas coisas. Poder maior só se obtém combinando —
...
8. **Toda força tem contramedida.** É uma máxima declarada do mundo. Nenhum Gu é perfeito;
   conhecer o Gu do inimigo é conhecer sua fraqueza. Consequência econômica: um Gu vale
   também pelo **segredo** — um Gu obscuro é quase imbatível até o mundo aprender a
   respondê-lo, e perde valor no dia em que fica famoso.
9. **A receita vale mais que o Gu.** Vender um exemplar rende pouco; vender a receita rende
   produção infinita. Receitas exclusivas valem ordens de grandeza mais que todos os
   exemplares somados, e são o verdadeiro tesouro de clãs e seitas.
10. **Falhar tem preço no corpo e na alma.** Erros de refino ferem fisicamente (curável) e
    ferem a alma (grave, lento, quase sem cura). Profissionais espaçam tentativas em cerca
...
12. **A partir de certo patamar, cada Gu é único no mundo.** Os [[Gu Imortais]] existem em
...
Isto é conhecimento comum. Um camponês analfabeto sabe boa parte; qualquer Mestre Gu de
nível baixo sabe tudo.

- **O que é um Gu e que existem nove níveis** (ranks 1 a 9), tanto para Gu quanto para
  Mestres. Ninguém em cidade nenhuma se surpreende com a existência de Gu.
- **Que Gu comem e que comida custa dinheiro.** Todo mundo sabe que criar Gu é caro — a
  comparação popular é que sustentar um Gu é como sustentar uma amante.
- **Que se refina um Gu antes de usá-lo**, que isso leva horas ou dias, e que é
  desconfortável e arriscado.
- **Que Gu de nível alto ficam mais caros e mais raros de forma brutal**, e que um Mestre
...
Isto é conhecimento de elite, de segredo de seita, ou verdade que o mundo simplesmente não
tem como saber. Em uma mesa de jogo, é material de mestre.
...
- **A trava de autodestruição dos Gu Imortais**: a vontade injetada durante o refino
  ...
  roubado é inútil, e por isso que os imortais dormem tranquilos.
- **Que Gu selvagens não têm essa trava** — são difíceis de refinar, nunca perigosos. Isso
  inverte todo o cálculo econômico entre "roubar" e "caçar".
- **A regra de unicidade como diagnóstico**: quando um refino tecnicamente impecável falha
  no último passo sem explicação, isso significa que **alguém no mundo já refinou aquele
  Gu**. É um teste indireto sobre o que existe no mundo.
- **A máxima do caminho do refinamento**: *"qualquer killer move é uma receita de Gu
  incompleta"* — e portanto qualquer golpe complexo pode, em princípio, ser condensado num
  único bicho. Isso é conhecimento de altíssimo nível e reescreve o teto do sistema.
- **Que os "caminhos" (paths) não são categorias naturais**: cada um foi **inventado e
  sistematizado por alguém**, em algum momento da história. Ver [[Visão Geral dos Paths]].

> [!note] Para o design
> As três alavancas mais jogáveis deste sistema, em ordem de retorno:
> **(1) Manutenção como recurso de campanha** — cada "magia" é uma boca que come. Isso
> transforma a ficha de personagem numa planilha de custeio e torna viagem longa, cerco e
> pobreza em ameaças mecânicas reais, sem precisar de dano.
> **(2) Informação como estatística de combate** — um poder desconhecido é forte; o mesmo
> poder, conhecido, é fraco. Isso dá valor de jogo a espionagem, a guardar segredo e a
> "queimar" um truque no momento certo.
> **(3) Crafting com falha destrutiva e escalonada** — refinar e fundir têm chance de
> ferir o personagem, matar o material e desperdiçar meses. É uma economia de risco, não
> uma loja.

## Mapa desta pasta

- [[O que é um Gu]] — a natureza da criatura, selvagens contra refinados, a vontade interna.
- [[Usar e Alimentar Gu]] — o custo diário: essência, dietas, fome, o teto de quantos se carrega.
- [[Refino de Gu]] — como um Gu vira "seu": a guerra de desgaste, o contra-ataque, os riscos.
- [[Fusão de Gu]] — como Gu evoluem: receitas, taxas de falha, escalonamento de poder.
- [[Gu Imortais]] — o topo do sistema e a regra de unicidade global.
