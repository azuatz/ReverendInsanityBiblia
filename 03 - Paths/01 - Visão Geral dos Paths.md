...
3. **Caminhos nascem, dominam e morrem.** Não são categorias eternas: são invenções
   ...
   [[04 - Strength Path|caminho da força]] o substituiu e já está em declínio.
...
9. **Conflito e ressonância entre caminhos são quantificados.** Em um território saturado
   ...
   [[02 - Tabelas de Referência Rápida#7. Amplificação por dao marks]]; use aquela nota como
   valor de referência.
...
> rank 6 → 7 → 8 → 9, e está em [[05 - Ranks e Avanço|Ranks e Avanço]] e
> [[02 - Tabelas de Referência Rápida#8. Cadência de calamidades e tribulações]].
