...
o [[15 - Theft Path|do roubo]] — chama isso de "o maior roubo que existe" e diz que **o mundo** é
quem o pratica. Ver [[13 - Blessed Lands e Grotto-Heavens|Blessed Lands e Grotto-Heavens]].
...
- **Ele exclui o [[18 - Time Path|caminho do tempo]] de vez.** Não é penalidade: *estando cheio de
...
- **Melodia da Passagem de Yang** — golpe de **movimento**. Transforma o usuário em **ondas sonoras
  ...
  [[14 - Space Path|caminho do espaço]]: teleporta para um lugar inteiramente novo. **Os limites são
...
**Combina com:**
- **[[16 - Wisdom Path|Sabedoria]] + [[07 - Enslavement Path|escravização]] + [[12 - Soul Path|alma]]** —
  a fusão dos quatro é o que dá ao som o **vetor mental**. É o modelo de composição do caminho.
- **[[14 - Space Path|Space Path]]** — o golpe de movimento do caminho carrega poder espacial e
  teleporta.
- **[[23 - Luck Path|Luck Path]]** — a nona canção usa um Gu Imortal de sorte como núcleo.
- **[[24 - Human Path|Human Path]]** — existe um clone dedicado que cultiva caminho humano com som ao
  lado.

**Sofre contra:**
- **[[18 - Time Path|Time Path]] — a incompatibilidade mais dura.** *Porque ele estava cheio de
...
- [[18 - Time Path|Time Path]] — a incompatibilidade mais dura deste caminho.
- [[15 - Theft Path|Theft Path]] — o caminho que roubou o deserto que anula este.
- [[07 - Enslavement Path|Enslavement Path]] — o parceiro na canção que converte feras.
- [[23 - Luck Path|Luck Path]] — o núcleo da nona canção.
- [[08 - Killer Moves|Killer Moves]] — como as canções se montam como golpes.
