...
# Wisdom Path (caminho da sabedoria)

**Em uma frase:** o caminho de **pensar melhor** — deduzir verdades a partir de evidências,
prever comportamentos, projetar receitas e golpes que ninguém mais conseguiria montar — e de
...
onisciência**. É dedução a partir de evidências. O praticante que não tem informação não
deduz nada; o que tem informação demais para processar deduz mais rápido que qualquer um.

É raro, mas nunca desapareceu ao longo da história — o que faz sentido: um caminho que
melhora a capacidade de resolver problemas nunca fica obsoleto, mesmo quando os recursos que
sustentavam outros caminhos se esgotam.

A moeda deste caminho é peculiar e define tudo: **lifespan**, o tempo de vida restante do
usuário. Pensar melhor custa viver menos. É a única escola do mundo cujo recurso não se
regenera.

## Mecânicas típicas

### A hierarquia da vida interior

A base teórica do caminho é uma taxonomia da mente, e ela é a espinha dorsal de vários outros
caminhos:

**pensamento → vontade → emoção**

- **Pensamentos** colidem entre si e se fundem, formando pensamentos novos. Pensar é
  literalmente isso: colisão.
- **Muitos pensamentos formam uma vontade** — uma entidade capaz de agir de forma autônoma,
  separada do corpo.
...
O mesmo vale para os ramos do [[21 - Rule Path|caminho da regra]].
...
Pensamentos não são intercambiáveis: cada subtipo é bom numa **tarefa** e ruim em outras.
Pensamentos maliciosos servem para tramar. Pensamentos de memória servem para vasculhar
lembranças. Pensamentos-estrela servem para deduzir — e são drasticamente mais eficientes
nisso: um pensamento-estrela vale por três ou quatro dos outros em trabalho dedutivo.

Há também uma advertência de eficiência: usar uma **vontade** para pensar é desperdício. A
imagem que a obra usa é a de um sabre usado para cortar legumes.
...
As regras que a cercam são precisas:
...
Como calibração de escala: fundir um único Gu Imortal a um golpe combinado custou dez mil
pensamentos-estrela e três dias. Criar um golpe de campo de batalha do zero leva cerca de um
mês com a luz, contra mais de três anos sem ela.

### O preço em tempo de vida

Este é o traço mais característico, e a obra é generosa com números:
...
[[21 - Rule Path|caminho da regra]] têm, na obra, um **estatuto especial** que nenhum outro tem —
...
[[08 - Attainment|domínio]] de um caminho é pessoal, custa séculos, e não se copia. É a razão pela
...
[[17 - Zumbis e Corpos Transformados|Zumbis e Corpos Transformados]] e [[12 - Longevidade|Longevidade]].
...
|---|---|---|
| Gu da Sabedoria ⭐ | 9 | A luz da sabedoria; acelera pensamento e dedução ao custo de vida |
| Segredo Celestial ⭐ | 7 → 8 | Pergunta direta a céu e terra; prevê até o conteúdo de tribulações |
| Espada da Sabedoria ⭐ | 8 | Contraria o próprio caminho da sabedoria; corta marcas alheias |
| Casco de Tartaruga Adivinha ⭐ | 7 | Defende o portador contra deduções alheias |
| Amor Próprio ⭐ | 7 | Núcleo de um golpe que limpa a mente de influências externas |
| Pensamento Vajra ⭐ | 6 | Até dez mil "pensamentos" interceptam ataques físicos |
| Desvendar Mistério ⭐ | 6 | Deduz rastros de heranças; base dos golpes de sonho |
...
**Fora de combate**, é o caminho mais poderoso que existe — e a obra não disfarça isso:

- **Prever o comportamento de um alvo** sem nenhuma vigilância direta.
- **Rastrear inimigos por flutuações da alma.**
...
**Em combate**, o caminho tem duas caras. A primeira é de suporte: **batalha de vontades**,
uma habilidade treinável — a proporção de perdas de um praticante melhorou de 1 para 100 até
1 para 4 com prática. A segunda é de dano direto, e é engenhosa: existe um golpe que
**converte os pensamentos dos inimigos em munição**, forte contra grupos e fraco contra alvo
único.

Duas limitações que salvam o caminho de ser onipotente:

- **A dedução tem alcance regional.** Localizar alguém falha se ele estiver noutra região, ou
  dentro de um território fechado, ou sob ocultação de nível equivalente.
- **Vasculhar uma alma nunca transfere erudição.** Extrai memórias e fatos; a compreensão
  pessoal do Dao é intransferível. Ver [[01 - Visão Geral dos Paths|Visão Geral dos Paths]].

## Sinergias e fraquezas

**Combina com:**
- **[[08 - Refinement Path|Refinement Path]]** — casamento obrigatório. Modificar receitas exige erudição
  simultânea no caminho do Gu, no refinamento **e** na sabedoria.
- **[[19 - Star Path|Star Path]]** — os pensamentos-estrela são o combustível dedutivo mais eficiente, e é
  possível entrar no caminho da sabedoria através do das estrelas.
- **[[12 - Soul Path|Soul Path]]** e **[[07 - Enslavement Path|Enslavement Path]]** — "quase da mesma origem"; todos operam sobre
  a vida interior.
- **[[26 - Dream Path|Dream Path]]** — o principal substituto de acesso a sonhos vem daqui.
- **[[21 - Rule Path|Rule Path]]** — os dois caminhos que deixam "significado verdadeiro" com muito mais
  ...
  conseguir.
- **[[17 - Information Path|Information Path]]** — o par canônico, e a obra chega a perguntar
  retoricamente por que os dois são os mais compatíveis que existem: um **busca** a informação, o
  outro a **deduz**.
- **[[09 - Formation Path|Formation Path]]** — a dupla operacional: a sabedoria deduz e modifica a
...
- **Fadiga não curável.** Quem vasculha almas repetidamente sofre uma exaustão própria que os
  métodos de cura de alma comuns não resolvem.

> [!note] Para o design
> **Arquétipo entregue: o estrategista.** Não o "mago inteligente" — o **planejador**. Este é
> o personagem que ganha a batalha na semana anterior, e que em combate direto é mediano.
>
> **A mecânica a roubar é o recurso que não regenera.** Tempo de vida como moeda de poder
> muda tudo: cada uso é irreversível, cada pergunta é uma decisão de orçamento existencial, e
> o personagem envelhece visivelmente ao longo da campanha. É a mecânica de custo mais
> dramática do sistema inteiro, e ela funciona sem nenhuma barra de sanidade ou corrupção.
>
> **O custo fixo que mata.** Um efeito que cobra cinquenta anos, sempre, e mata quem tem menos
> que isso, é um item que o grupo precisa **auditar antes de usar** — e que eventualmente
> alguém vai usar sem auditar. É um dispositivo dramático embutido numa regra.
>
> **Dedução como recurso de mesa.** Em vez de o mestre entregar informação, o jogador
> **gasta** para obtê-la, com teto de sessão (sete dias) e risco de lesão por excesso. Isso
> transforma investigação numa economia e dá ao mestre uma torneira controlável.
>
> **Erudição intransferível.** A regra de que ler a alma de um gênio não te torna gênio impede
> que o grupo resolva tudo capturando um sábio — e força a busca por métodos mais estranhos.
...
- [[01 - Visão Geral dos Paths|Visão Geral dos Paths]] — o que é um caminho e a escala de erudição.
- [[08 - Refinement Path|Refinement Path]] — o parceiro obrigatório na modificação de receitas.
- [[19 - Star Path|Star Path]] — a fonte de combustível dedutivo.
- [[12 - Soul Path|Soul Path]] — a origem compartilhada.
- [[26 - Dream Path|Dream Path]] — o acesso a sonhos por via dedutiva.
- [[16 - Gu Imortais|Gu Imortais]] — a brecha de sabedoria que permite refinar Gu roubados.
- [[17 - Information Path|Information Path]] — o par canônico: um busca, o outro deduz.
- [[09 - Formation Path|Formation Path]] — a dupla que deduz e monta formações.
- [[16 - Dao Marks|Dao Marks]] — as marcas que os golpes deste caminho queimam para sempre.
- [[08 - Attainment|Attainment]] — o domínio que este caminho é o único capaz de transferir, e o preço da transferência.
