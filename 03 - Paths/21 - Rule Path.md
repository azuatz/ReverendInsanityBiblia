...
# Rule Path (caminho da regra)

**Em uma frase:** o caminho dos **conceitos abstratos universais** — grande e pequeno, alto e
...
Este é o caminho mais **universal** que existe, e a obra o coloca explicitamente em primeiro
lugar em abrangência.

Sua matéria-prima não são fenômenos — fogo, água, sangue —, e sim **conceitos**. Grande e
pequeno. Perto e longe. Bom e mau. Forte e fraco. Verdadeiro e falso. Os números.

Como conceitos se aplicam a tudo, os Gu deste caminho se aplicam a tudo. **Qualquer Gu de
regra pode ser acoplado a um golpe combinado de qualquer outro caminho para reforçá-lo.** Não
há incompatibilidade temática, porque o caminho não tem tema — tem gramática.

Isso o torna o **caminho-mãe**: o caminho da restrição e o caminho do fantasma são
formalmente **sub-ramos** dele, ainda não plenamente separados, do mesmo modo que o caminho
da emoção é sub-ramo do [[16 - Wisdom Path|caminho da sabedoria]].

E ele é mais fundamental que os caminhos de cultivo em geral: marcas do Dao de regra aparecem
até em **feras selvagens** que nunca cultivaram nada — a categoria "vida" e a categoria
"morte" existem no mundo antes de qualquer cultivador organizá-las.

> [!warning] Uma lacuna reconhecida na própria obra
> Apesar de toda essa importância, **o mecanismo interno do caminho da regra nunca é
> explicado**. A obra dá exemplos, dá efeitos, dá a cor das marcas (prateada) e dá a posição
> hierárquica — mas nunca uma formulação de como ele funciona por dentro. É a lacuna teórica
> mais duradoura do sistema, e um espaço em branco deliberado para quem for adaptar o cenário.
...
Os Gu Imortais do caminho aplicam conceitos como se fossem leis físicas, e o resultado é
sempre desconcertantemente simples:

- **"Pequeno"** — um campo que **encolhe e enfraquece qualquer ataque** que se aproxime. Não
  importa o caminho de origem do ataque: ele fica menor. Universal por construção.
- **"Desintegrar"** — desintegra quase qualquer elemento místico. A escala é dada pelos
  números: cem, mil, dez mil desintegrações, conforme o nível.
- **"Sentença de morte aguarda"** — fixa o momento exato da morte de um alvo.
- **"Tornar-se real"** — deixa uma trilha prateada persistente que serve de **âncora** para
  outros golpes.
- **"Grande"** — aumenta o tamanho físico do usuário. Note: **o tamanho, não a força**. O
  caminho aplica o conceito literalmente, e não o que você gostaria que ele significasse.

Esse último detalhe é a melhor ilustração da identidade do caminho: ele opera sobre a
categoria, não sobre a consequência prática que você esperava.

### A regra de confronto interno

Uma regra formal e limpa: **dentro do mesmo caminho, um confronto direto se decide pelo nível
do Gu Imortal**. Sem sutilezas, sem contra-jogo temático. Conceito contra conceito, vence o
mais alto.
...
Junto com o [[16 - Wisdom Path|Wisdom Path]], este é um dos **dois caminhos que deixam "significado
...
> é raríssimo. A exceção absoluta é o [[25 - Heaven Path|caminho do céu]], cujo significado
...
> **[[22 - Phantom Path|caminho fantasma]]**.
...
- **[[22 - Phantom Path|Caminho fantasma]]** — *derivado do caminho da regra; concentra-se em
...
ramos do [[16 - Wisdom Path|caminho da sabedoria]].
...
**criar marcas do Dao que ainda não existiam**. Ver [[25 - Heaven Path|Heaven Path]].
...
como a descrição sugere. Essa discrepância de uma única unidade de tempo colapsava golpes
combinados inteiros e gerava backlash severo. A correção foi acrescentar Gu do
[[18 - Time Path|caminho do tempo]] para compensar a margem. Ver [[08 - Killer Moves|Killer Moves]].

## Em combate e fora dele

**Em combate**, o caminho da regra é o **contra universal**. Um campo que encolhe qualquer
ataque não pergunta de que caminho o ataque veio. Um Gu que desintegra elementos místicos não
distingue fogo de sombra. É o único caminho que responde bem a **tudo**, e por isso o mais
valioso como caminho secundário.

A contrapartida é que ele não é espetacular em nada específico: onde um caminho especializado
tem um golpe devastador contra um tipo de alvo, o caminho da regra tem uma resposta razoável
contra todos.
...
- **[[16 - Wisdom Path|Wisdom Path]]** — os dois caminhos que deixam significado verdadeiro com muito mais
  facilidade que os demais, porque um porta a verdade e o outro porta a vontade.
- **[[08 - Refinement Path|Refinement Path]]** — a dupla exigida para as conquistas territoriais de maior nível.
...
- **[[18 - Time Path|Time Path]]** — usado para corrigir margens de sincronia nos golpes do caminho da regra.

**Sofre contra:**
- **Nível superior no mesmo caminho.** A regra de confronto interno é implacável: conceito
  contra conceito, vence o Gu mais alto. Não há como jogar melhor.
- **Falta de especialização.** Responder razoavelmente a tudo significa não vencer
  decisivamente nada.
- **Literalidade.** Os conceitos se aplicam ao pé da letra. Um Gu que torna você "grande" não
  torna você forte. Errar a interpretação de uma regra é errar o golpe inteiro.
...
> desejada e a mais perigosa que um sistema pode oferecer. Note que a obra deixa o teto de
> empilhamento **em aberto** — para uma mesa real, esse é exatamente o número que precisa ser
> fixado antes de publicar.
>
> **Conceitos aplicados literalmente.** "Grande" aumenta o tamanho, não a força. Fazer os
> efeitos obedecerem à letra do conceito e não à intenção do usuário cria um sistema mágico
> que recompensa precisão de raciocínio e pune expectativa — o que é uma fonte inesgotável de
> boas decisões e de bons desastres.
>
> **Um sub-caminho que ainda não se separou.** Ter escolas menores formalmente reconhecidas
> como ramos incompletos de uma escola maior é um detalhe de mundo barato e eficaz: sugere que
> a taxonomia mágica é obra humana em progresso, não uma lei da natureza.
>
> **Um caminho sem explicação declarada.** Se a própria obra deixa o mecanismo em branco, um
> designer pode preenchê-lo. É o espaço mais convidativo do cenário inteiro para uma
> contribuição autoral.

## Praticantes notáveis (sem enredo)

- **[[02 - Os Criadores de Caminhos|Limitless Demon Venerable]]** — nível 9, criador do caminho da
  regra. É também a
  ...
  Ver [[25 - Heaven Path|Heaven Path]].
- Um dos Gu mais notáveis do caminho, quarto colocado na lista mundial de Gu místicos, foi
  refinado por ele a partir de um domínio recluso — e é capaz de **anular qualquer acordo de
  aliança, independentemente do caminho que o sustenta**.

## Relações

- [[01 - Visão Geral dos Paths|Visão Geral dos Paths]] — o que é um caminho, e a arquitetura de sub-ramos.
- [[16 - Wisdom Path|Wisdom Path]] — o outro caminho que deixa significado verdadeiro com facilidade, e a
  origem do caminho da emoção.
- [[22 - Phantom Path|Phantom Path]] — o ramo mais desenvolvido deste caminho, e o único com nota própria.
- [[29 - Os Demais Caminhos|Os Demais Caminhos]] — o caminho da restrição e a árvore completa de derivação.
- [[08 - Refinement Path|Refinement Path]] — o par exigido nas conquistas territoriais de maior nível.
- [[25 - Heaven Path|Heaven Path]] — o problema que o criador deste caminho resolveu.
- [[08 - Killer Moves|Killer Moves]] — como Gu de regra reforçam golpes de qualquer outro caminho.
- [[15 - Conflito de Marcas e Compatibilidade|Conflito de Marcas e Compatibilidade]] — o problema que só este caminho resolve.
- [[09 - Formações de Gu|Formações de Gu]] — o alvo preferencial do golpe de topo do caminho.
- [[16 - Dao Marks|Dao Marks]] — as marcas de vida e de morte, que são de regra, e a derivação de marcas novas.
- [[04 - As Cinco Regiões|As Cinco Regiões]] — as barreiras regionais de onde saiu o golpe supremo do caminho.
- [[18 - Lugares Fora das Cinco Regiões|Lugares Fora das Cinco Regiões]] — o mapa dos domínios reclusos, entre eles os três da regra.
