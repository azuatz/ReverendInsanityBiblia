...
**Em uma frase:** ==ninguém escolhe um caminho de cultivo numa ficha em branco== — a
especialidade de um Mestre Gu se forma sozinha ao longo de décadas, a partir do que ele
conseguiu comprar, herdar e sobreviver, e só se fecha de vez no instante da ascensão à
imortalidade.
...
## A vida mortal: tendência, não classe

Comece pelo começo, porque é aqui que a intuição de RPG atrapalha mais.

Aos quinze anos, uma pessoa passa pela [[Abertura|Cerimônia do Despertar]] e descobre se
tem uma abertura — o órgão espiritual que a torna Mestre Gu — e de que tamanho ela é. Nesse
momento **ninguém pergunta a ela qual caminho quer seguir**, e a pergunta nem faria sentido:
não existe formulário, não existe declaração, não existe instituição que registre a escolha.
...
### As quatro forças que formam a tendência

O que um Mestre Gu acaba tendo não é o que ele queria; é o que essas quatro coisas
permitiram:

1. **Os recursos disponíveis.** Gu custam dinheiro, e caro. A maior parte dos cultivadores
   do mundo compra o que dá para pagar, não o que gostaria. É por isso que o
   [[Strength Path|caminho da força]] domina entre os pobres: é barato de acionar, o ganho é
   permanente, e não exige nenhuma sofisticação. Ele não é o caminho dos fracos — é o
   caminho dos **acessíveis**.
2. **A herança do clã.** Clãs mantêm acervos, receitas e linhas de transmissão próprias. Um
   jovem de um clã que cultiva um caminho há gerações recebe Gu daquele caminho, é ensinado
   por anciãos daquele caminho e é avaliado pelos critérios daquele caminho. A tendência
   dele foi decidida antes de ele nascer.
3. **A aptidão.** O grau de aptidão — de D a A, medido naquela cerimônia — fixa quanta
   essência a abertura guarda, e com isso o teto prático de carreira. Ela não aponta para um
   caminho específico, mas decide **quanto** de qualquer caminho a pessoa vai conseguir
   percorrer, e portanto se vale a pena o clã investir nela. Ver [[Aptidão]].
4. **A oportunidade.** Gu selvagens capturados, espólio tomado de um inimigo morto, uma
   herança encontrada por acaso, um leilão em que apareceu justamente aquele bicho. Uma
   parcela enorme do arsenal de qualquer Mestre Gu é **achado**, não planejado.

> [!note] O que isso substitui
> Em quase todo RPG, a especialidade vem antes do inventário: você escolhe ser mago, e daí
> decorre que seus itens são de mago. Aqui a ordem é a inversa — o inventário vem primeiro,
> e a especialidade é o **padrão que ele desenha depois**. Um personagem deste mundo não
...
- **Escolher uma especialização funcional** entre seis direções — ataque, defesa, cura,
  ...
  Gu por encomenda para outros ou capturar Gu selvagens. Isso é uma escolha de **papel**, e é
  transversal aos caminhos: existe ataque em vários caminhos, cura em vários caminhos.
- **Montar um conjunto de Gu** — um Gu núcleo mais Gu de suporte que trabalham juntos. E a
  prática recomendada é que o conjunto seja **do mesmo caminho**, por três razões somadas:
...
ela acontece antes de qualquer um entender o que está escolhendo.

Todo Mestre Gu tem um ==Gu Vital==: o Gu com o qual ele tem o vínculo de refino mais antigo
e mais profundo, quase sempre o primeiro que refinou na vida. A consagração é automática e
imediata — acontece no instante em que o primeiro refino se completa, sem ritual, sem
declaração, sem período para reconsiderar. E os Gu seguintes que a pessoa adquire são
escolhidos **para complementar o Vital**, o que já começa a puxar a tendência numa direção.

Onde mora a escolha, então? Em **qual Gu você refina primeiro** — decisão normalmente tomada
pelo clã, não pelo jovem, com base na aptidão que ele acabou de revelar e no que o clã está
disposto a gastar. Um adolescente, um Gu barato, e nenhuma consciência de que aquilo vai
...
morte. A nota dona do assunto é [[Gu Vital]]; guarde daqui apenas que **o Vital é o único
compromisso realmente vinculante que se assume no mundo mortal**, e que ele é assumido cedo
demais para ser informado.

## O que já fecha portas antes da ascensão

Enquanto o cultivador acha que ainda não escolheu nada, o corpo dele já está escolhendo por
ele — e de forma irreversível.
...
que a pessoa faz naquela linha de conhecimento. A teoria completa está em [[Dao Marks]].
...
[[Conflito de Marcas e Compatibilidade]], e ela deve ser lida antes de qualquer decisão de
build.

Três acumuladores silenciosos operam durante toda a vida mortal:

- **Modificações corporais permanentes.** Cada tendão convertido em aço, cada camada de pele
...
O retrato que sai disso é o núcleo desta nota inteira. Um veterano do caminho da força é um
lutador excelente, difícil de matar, lento de curar, incapaz de teleportar-se e incapaz de
virar luz. **Ele não escolheu isso num menu.** Escolheu ao longo de anos, um Gu de cada vez,
e a maior parte dessas portas se fechou sem que ninguém avisasse.

Reverter existe e é caro: há Gu especializados em desfazer modificações corporais. Mas
