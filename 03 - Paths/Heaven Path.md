...
2. **Roubo de tribulação.** Um golpe do caminho do roubo captura as marcas caóticas de uma
   tribulação **em curso** e as fixa num material; um golpe do [[Food Path|caminho da comida]]
...
acionados, eles saem do corpo e perdem a proteção. Ver [[Killer Moves]].
...
**Combina com:**
- **[[Refinement Path]]** — a única via de acesso. Refinar marcas do céu é uma operação de
  refinamento, e o caminho nasceu como um problema de refinadores.
- **[[Food Path]]** — uma das três fontes de marcas passa por converter material roubado em
  marcas do céu por ingestão.
- **[[Wisdom Path]]** — prever a forma seguinte de uma tribulação adaptativa é indispensável.
...
- **Impossibilidade de herança.** **Não existe "significado verdadeiro" do caminho do céu**
  para ninguém herdar. O atalho que serve ao [[Rule Path]] e ao [[Wisdom Path]] não existe
...
- [[Visão Geral dos Paths]] — o que é um caminho e o limiar de entrada deste.
- [[Refinement Path]] — a única via de acesso.
- [[Food Path]] — uma das três fontes de marcas do céu.
- [[Rule Path]] — o caminho cujo criador resolveu o problema fundacional.
- [[Killer Moves]] — a incompatibilidade com totens e estruturas externas.
- [[Luck Path]] — o caminho vizinho, que trata de sorte onde este trata de destino.
