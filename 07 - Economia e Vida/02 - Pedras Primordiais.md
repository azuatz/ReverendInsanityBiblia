...
```mermaid
flowchart LR
    A["Pedra completa<br/>ovo de pato · cheia"] -->|drenagem parcial| B["Pedra usada<br/>menor e mais leve"]
    B -->|mais drenagem| C["Pedra quase vazia<br/>pequena e leve"]
    C -->|última gota| D["Pó branco<br/>sem valor"]
    A -.->|circula como 1| E["Pagamento"]
    B -.->|circula como fração| E
```
