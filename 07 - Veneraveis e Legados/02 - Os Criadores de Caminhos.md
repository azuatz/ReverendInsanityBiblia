...
| **Caminho de especialidade** | **[[05 - Transformation Path\|transformation path]]** (caminho da transformação) — criou os dois |

### O que ele deixou no mundo

**1. Dois caminhos de uma vez.** É o progenitor tanto do [[04 - Strength Path|caminho da força]] quanto do [[05 - Transformation Path|caminho da transformação]] — o único dos dez creditado pela fundação de duas disciplinas. Toda tradição marcial do mundo, todo cultivador que amplifica o próprio corpo e todo praticante que assume a forma de uma fera descende tecnicamente dele.

**2. O corpo como campo de batalha.** As técnicas que ele estabeleceu incluem transformar-se em incontáveis feras diferentes e reconstituir-se **a partir de uma única gota de sangue** — o que, na prática, fixa no cenário o padrão de "inimigo que não fica morto" e a mecânica de descartar peles como fuga. Existe registro de ele escapar de uma prisão mágica de alto nível simplesmente **abandonando três peles ensanguentadas**.
...
**2. A infraestrutura de saúde do mundo imortal.** Criou uma [[07 - Killer Moves|Casa de Gu Imortal]] de rank 8 — uma estrutura tripulada, montada com Gu Imortais, de efeito fixo e sem risco de falha — em que **cada lótus armazena uma [[09 - Blessed Lands e Grotto-Heavens|abertura imortal]] inteira**, com capacidade de autocura extrema. Traduzindo o que isso significa no cenário: existe, graças a ele, um lugar onde um cultivador imortal gravemente ferido pode ser guardado e recomposto — e onde essas aberturas podem ser abrigadas.

Isso resolve um problema estrutural do mundo. A ==[[09 - Blessed Lands e Grotto-Heavens|abertura imortal]]== é o mundo de bolso que todo imortal carrega dentro de si — casa, fonte de renda e órgão de cultivo ao mesmo tempo, e por isso mesmo **a base material dele**. Um imortal ferido na própria abertura está ferido em tudo o que tem. A existência de um depósito e hospital para aberturas cria uma categoria inteira de serviço, dependência e chantagem.

**3. A linhagem dos lótus de essência.** Criou uma família de Gu cuja função é ser uma **nascente espiritual portátil** — a fonte de energia de cultivo, normalmente presa ao solo, transformada em objeto que se carrega. O exemplar de rank 6 dessa linhagem figura entre os dez maiores Gu Imortais do mundo.
...
| **Caminho principal** | **[[10 - Soul Path\|soul path]]** (caminho da alma) — ele o criou |
| **Traço distintivo** | a **natureza mais assassina** dos dez |

### O que ele deixou no mundo

**1. O [[10 - Soul Path|caminho da alma]]**, e com ele todo o aparato do cenário para atacar, ler, dividir, modificar, transplantar e aprisionar almas. Praticamente toda a mecânica de possessão, interrogatório de alma e sobrevivência post-mortem do mundo é ramo dessa disciplina.

**2. Duas terras sagradas.** Foi ele quem identificou e classificou as duas regiões do mundo saturadas de [[12 - Dao Marks|marcas de dao]] de alma — uma montanha que faz as almas tremerem e um vale de neblina que corta almas — como as terras sagradas do caminho da alma. Elas são geografia mítica retirada das [[08 - Lendas de Ren Zu|Lendas de Ren Zu]] que existe fisicamente no mundo, e podem ser **fisicamente arrancadas do solo e guardadas dentro de uma [[09 - Blessed Lands e Grotto-Heavens|abertura imortal]]**, servindo de reserva permanente de marcas de dao.
...
O que isso permite, mecanicamente, é que um único indivíduo seja simultaneamente dezenas de pessoas espalhadas pelo mundo ao longo de eras. `conhecimento: segredo` — organizações inteiras e mundialmente distribuídas do cenário eram, na verdade, um homem só operando sozinho por trás de todas as máscaras.
...
**5. Domínio de todos os caminhos.** `conhecimento: segredo` — tinha [[06 - Attainment|attainment]] alto em **todas** as disciplinas ao mesmo tempo, o que lhe dava uma capacidade única: **anexar qualquer abertura imortal**, sem a restrição que obriga todos os outros a só engolir aberturas da disciplina que dominam. Ver [[09 - Blessed Lands e Grotto-Heavens#Anexação: engolir uma dimensão com a sua]].

**6. A obra final.** `conhecimento: segredo` — um Gu de rank 9 que **fabrica artificialmente um corpo com o status de demônio de outro mundo**. Ou seja: uma máquina para produzir a única categoria de ser imune ao [[12 - Fate Gu|Fate Gu]] e capaz de feri-lo. É a tentativa mais direta que alguém já fez de manufaturar a exceção às leis do mundo.
...
- **A nona camada perfura a fronteira do mundo.** Ver [[13 - Cosmologia#A fronteira do mundo]]. A formação dele fura deliberadamente o ponto mais fino da membrana externa do mundo e **puxa matéria de fora para dentro como matéria-prima**. É a explicação estrutural dos demônios de outro mundo: eles não são anomalia — são subproduto da obra dele.
...
| **Caminho principal** | **[[18 - Luck Path\|luck path]]** (caminho da sorte) — ele o criou, e o manteve em segredo |
...
A engrenagem central é o ciclo de assembleias e o trono que se disputa **a cada dez anos** entre tribos, descrito em [[08 - Eventos e Instituições Jogáveis|Eventos e Instituições Jogáveis]]. O que esta nota acrescenta é a **intenção** por trás do desenho, e ela é de uma frieza notável. O ciclo serve a três objetivos ao mesmo tempo:
...
Ele refinou, com a ajuda do maior refinador da história, uma [[07 - Killer Moves|Casa de Gu Imortal]] de rank 8 — o ==Edifício dos Oitenta e Oito Yang Verdadeiros== (*Eighty-Eight True Yang Building*) — que fica dentro da abertura imortal que serve de trono às Planícies do Norte. O que ela faz:
...
- [[13 - Tornar-se Venerável|Tornar-se Venerável]] — a fonte única sobre o Dao Lord: como se ganha o senhorio de um caminho, e como se perde.
- [[01 - Visão Geral dos Paths|Visão Geral dos Paths]] — o mapa das disciplinas de cultivo; cinco delas nasceram aqui.
- [[04 - Strength Path|Strength Path]] · [[05 - Transformation Path|Transformation Path]] · [[10 - Soul Path|Soul Path]] · [[16 - Rule Path|Rule Path]] · [[18 - Luck Path|Luck Path]] — as disciplinas fundadas pelos cinco desta nota, em detalhe de mesa. (O caminho da madeira, de Genesis Lotus, ainda não tem nota própria.)
- [[09 - Linha do Tempo e Eras|Linha do Tempo e Eras]] — em que era cada um destes cinco viveu.
- [[06 - Attainment|Attainment]] — o supremo grão-mestre, degrau sem o qual não se funda caminho nenhum.
- [[13 - Cosmologia|Cosmologia]] — a fronteira do mundo, perfurada pela obra de Limitless.
- [[09 - Blessed Lands e Grotto-Heavens|Blessed Lands e Grotto-Heavens]] — as aberturas imortais que Genesis Lotus aprendeu a guardar e que Spectral Soul aprendeu a engolir sem restrição.
- [[08 - Lendas de Ren Zu|Lendas de Ren Zu]] — a origem mítica das terras sagradas do caminho da alma.
- [[18 - Luck Path|Luck Path]] — a disciplina que Giant Sun criou e escondeu, em detalhe.
- [[08 - Eventos e Instituições Jogáveis|Eventos e Instituições Jogáveis]] — o ciclo do trono das Planícies do Norte visto como evento jogável; aqui está a intenção por trás dele.
- [[12 - Fate Gu|Fate Gu]] — o instrumento que governa a certeza, e que a criação secreta de Giant Sun deixou incompleto.
