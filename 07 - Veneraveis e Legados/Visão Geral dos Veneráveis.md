...
**Em uma frase:** ==Venerável== é o título de quem alcançou o rank 9 — o teto absoluto do sistema de poder deste mundo —, algo que **apenas dez pessoas conseguiram em toda a história**, e cujo efeito colateral inevitável foi reescrever permanentemente como o mundo funciona.

Esta é a nota-porta da pasta **Veneráveis e Legados**.

## Resumo

Neste mundo, o poder de um cultivador vai de rank 1 a rank 9. Ranks 1 a 5 são o mundo mortal: gente que vive uma vida humana e morre. A partir do rank 6 começa a imortalidade — não no sentido de não morrer, mas de viver séculos ou milênios e habitar um mundo privado próprio. Rank 8 é a camada política do mundo: cada gesto de um rank 8 remodela uma região inteira. E acima disso há o rank 9.

O rank 9 não é "o rank 8 mais forte". É uma **categoria diferente de existência**. Um Gu de rank 9 não é feito de marcas de dao acumuladas como todos os outros: é feito de fragmentos da própria Grande Dao. Um rank 8 nunca venceu um rank 9 em toda a história registrada — não existe uma única exceção. O texto usa a imagem de pisar numa formiga.
...
1. **Venerável = rank 9.** Quem chega lá pela via ortodoxa recebe o título de *Immortal Venerable* (Venerável Imortal); quem chega pela via demoníaca, *Demon Venerable* (Venerável Demônio). É rótulo de método e reputação, não de força — os dois são igualmente invencíveis.
...
8. **Todos criaram métodos de human path de alto nível** a partir da compreensão das [[Lendas de Ren Zu]]. Sem exceção, os dez leram a mitologia fundadora do mundo como manual técnico.
9. **O legado sobrevive ao portador.** Golpes lendários de Veneráveis mortos aparecem sozinhos dentro de desastres naturais séculos depois; suas vontades residuais continuam operando dentro de suas criações; e o path que fundaram carrega a assinatura deles para sempre (ver [[#Dao Lord]]).
...
Quando um Venerável atinge o nível de supremo grão-mestre no seu caminho principal, ele se torna um ==Dao Lord== (Senhor do Dao) daquele caminho. O efeito é assustador na sua simplicidade: ele passa a **sentir e refinar automaticamente todas as marcas de dao daquele caminho existentes no mundo inteiro**, e a manipulá-las à vontade.

É esse o segredo por trás de duas coisas que, sem ele, pareceriam arbitrárias:

- **A invencibilidade.** Um Dao Lord do caminho da força não luta contra um usuário do caminho da força; ele é o dono do campo em que o outro está pisando.
- **A permanência dos legados.** Quando um Venerável funda uma disciplina, ele não escreve um manual — ele assina o path inteiro. É por isso que os métodos dele continuam funcionando eras depois de sua morte, e por que o mundo inteiro pode aprender a disciplina dele sem nunca conseguir sair da sombra dele.
