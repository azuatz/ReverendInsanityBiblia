...
ORDEM = {
    ...
    "10 - Estudos de Caso Mecanicos": [
        ...
        "A Barreira Que Deixa Sair e Não Deixa Entrar", "O Ambiente Manda Mais que o Rank",
        "Sobrecarregar o Defensor que Devolve o Golpe", "Guerra de Custos",
        "Aposta de Rochas - Heurística, Perda e Álibi",
        "Ganhar um Leilão Sem Ser o Maior Lance", "Colher a Flor Antes do Prazo",
        "Comprar Antes que Seja Notícia", "A Conta de uma Calamidade", "Guerra de Preços",
        "Brechas de Contrato Mágico", "Reputação Comprada em Prestações",
        ...
        "Anexação de Aberturas", "Roubo de um Gu Imortal de Rank Superior",
        "A Armadilha que Engorda a Cada Teste", "Quando a Adivinhação Falha",
        "Curar o Dano para Repetir o Dano", "A Tribulação Como Matéria-Prima",
